					...
					<div class="blog-listing single-post col-md-12 p_z">
						<article>
							<div class="entry-cover">
								<img src="images/dropbox/avaluo.jpg" style="width: 50%" alt="blog" />
						...
						<div class="comments-area">
							<div class="comment-respond" id="respond">
								<p>Cu&eacute;ntenos c&oacute;mo podemos apoyar sus negocios por medio de un aval&uacute;o o un estudio de consultor&iacute;a inmobiliaria, y lo estaremos contactando de vuelta:</p>
