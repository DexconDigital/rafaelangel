					...
					<div class="blog-listing single-post col-md-12 p_z">
						...
						<article>
							...
							<div class="entry-header">
								...
								<p style="text-align: justify;">Si est&aacute;s interesado en trabajar con nosotros, comp&aacute;rtenos tus datos y adjunta la hoja de vida aqu&iacute; abajo:
						...
						<div class="comments-area">
							...
							<div class="comment-respond" id="respond">
								...
								<form class="comment-form" id="submitWorkUs" method="post" action="#">
									...
									<div class="col-md-12">
										...
										<input type="text" name="author" class="comments-line" required>
									...
									<div class="col-md-12">
										...
										<input type="number" name="phone" class="comments-line" required>
									...
									<div class="col-md-12">
										...
										<input type="email" name="email" class="comments-line" required>
									...
									<div class="col-md-12">
										...
										<input type="text" name="area" class="comments-line" required>
