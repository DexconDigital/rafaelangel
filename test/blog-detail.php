			...
			<div class="container-fluid p_z">
					...
					<div class="blog-listing single-post col-md-12 p_z">
						...
						<div class="related-post p_z row">
							...
							<div class="col-md-4 col-sm-12">
								<a title="Related post" href="#"><img src="images/blog/releted-post-1.jpg" alt="releted-post-1" /></a>
								<a title="Related post" href="#">Suspendisse non diamur imperdiet.</a>
							</div>
							<div class="col-md-4 col-sm-12">
								<a title="Related post" href="#"><img src="images/blog/releted-post-2.jpg" alt="releted-post-1" /></a>
								<a title="Related post" href="#">Lorem ipsun dolor sit amet felis</a>
							</div>
							<div class="col-md-4 col-sm-12">
								<a title="Related post" href="#"><img src="images/blog/releted-post-3.jpg" alt="releted-post-1" /></a>
						...
						<div class="entry-author">
							<img alt="author" src="images/blog/author.jpg">
						...
						<div class="comments-area">
							...
							<ul class="commentlist"> 
								<li>
									<div class="comment">
										<span class="comment-image">
											<img src="images/blog/disha-seth.jpg" alt="disha-seth">
										</span>
								...
								<li>
									<div class="comment">
										<span class="comment-image">
											<img src="images/blog/meera-nod.jpg" alt="meera-nod">
										</span>
										<h4 class="comment-info">
									...
									<ul class="children">
										<li>
											<div class="comment">
												<span class="comment-image">
													<img src="images/blog/pranva-thakur.jpg" alt="pranva-thakur">
												</span>
												<h4 class="comment-info">
								...
								<li>
									<div class="comment">
										<span class="comment-image">
											<img src="images/blog/nimesh-roy.jpg" alt="nimesh-roy">
										</span>
										<h4 class="comment-info">
				...
				<div class="col-md-3 col-sm-6 p_r_z blog-sidebar widget-area">
					...
					<aside class="widget widget-category">
						<h2 class="widget-title">Catagories of<span>property</span></h2>
						<ul>
							<li><i class="fa fa-angle-double-right"></i> <a title="comfort" href="#">Comfort</a></li>
							<li><i class="fa fa-angle-double-right"></i> <a title="Luxury" href="#">Luxury</a></li>
							<li><i class="fa fa-angle-double-right"></i> <a title="Market Updates" href="#">Market Updates</a></li>
							<li><i class="fa fa-angle-double-right"></i> <a title="Sales" href="#">Sales</a></li>
						</ul>
					...
					<aside class="widget widget-property-featured">
						...
						<div class="property-featured-inner">
							<div class="col-md-4 col-sm-3 col-xs-2 p_z">
								<a title="Popular Post" href="#"><img src="images/aa-listing/feacture1.jpg" alt="feacture1"></a>
							</div>
						...
						<div class="property-featured-inner">
							<div class="col-md-4 col-sm-3 col-xs-2 p_z">
								<a title="Popular Post" href="#"><img src="images/aa-listing/feacture2.jpg" alt="feacture2"></a>
							</div>
							<div class="col-md-8 col-sm-9 col-xs-10 featured-content">
								<a title="Popular Post" href="#">Heading Title here</a>
								<span><i class="fa fa-clock-o"></i> 03 April,2015</span>
						...
						<div class="property-featured-inner">
							<div class="col-md-4 col-sm-3 col-xs-2 p_z">
								<a title="Popular Post" href="#"><img src="images/aa-listing/feacture3.jpg" alt="feacture3"></a>
							</div>
							<div class="col-md-8 col-sm-9 col-xs-10 featured-content">
								<a title="Popular Post" href="#">Heading Title here</a>
								<span><i class="fa fa-clock-o"></i> 03 April,2015</span>
					...
					<aside class="widget widget-property-featured">
						...
						<div class="property-featured-inner">
							<div class="col-md-4 col-sm-3 col-xs-2 p_z">
								<a title="Featured Post" href="#"><img src="images/aa-listing/feacture1.jpg" alt="feacture1"></a>
							</div>
							<div class="col-md-8 col-sm-9 col-xs-10 featured-content">
						...
						<div class="property-featured-inner">
							<div class="col-md-4 col-sm-3 col-xs-2 p_z">
								<a title="Featured Post" href="#"><img src="images/aa-listing/feacture2.jpg" alt="feacture2"></a>
							</div>
							<div class="col-md-8 col-sm-9 col-xs-10 featured-content">
								<a title="Featured Post" href="#">Southwest 39th Terrace</a>
								<h3>&dollar;350000</h3>
						...
						<div class="property-featured-inner">
							<div class="col-md-4 col-sm-3 col-xs-2 p_z">
								<a title="Featured Post" href="#"><img src="images/aa-listing/feacture3.jpg" alt="feacture3"></a>
							</div>
							<div class="col-md-8 col-sm-9 col-xs-10 featured-content">
								<a title="Featured Post" href="#">Southwest 39th Terrace</a>
								<h3>&dollar;350000</h3>
