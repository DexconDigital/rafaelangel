...
class PHPMailer {
   ...
   * @var string
   */
  public $From              = 'noreply@simiinmobiliarias.com';

  /**
   * Sets the From name of the message.
   * @var string
   */
  public $FromName          = 'Agente Virtual Simi';
  ...
  */
   ...
   * @var string
   */
  public $Username      = 'noreply@simiinmobiliarias.com';

  /**
   * Sets SMTP password.
   * @var string
   */
  public $Password      = 'Desarrollo.2018';
