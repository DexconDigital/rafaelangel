				...
				<div class="col-md-9 col-sm-6 col-xs-12">
					...
					<div class="contact-feedback-form">
						...
						<form id="contact">
							...
							<div class="col-md-6 col-xs-12 ">
                              <label for="in-form-message" class="control-label">Actualmente es cliente de la empresa:</label>
                              <div class="radio">
                                <label><input type="radio" class="form-control" name="cliente"  value="Si"> &nbsp;Si</label>
                              </div>
                              <div class="radio">
                                <label><input type="radio" class="form-control" name="cliente" checked value="No"> &nbsp;No</label>
                              </div>
